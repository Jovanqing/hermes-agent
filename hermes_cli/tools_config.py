...
CONFIGURABLE_TOOLSETS = [
    ...
    ("revit",            "🏗️  Revit BIM",               "create walls, rooms, floors via pyRevit API"),
]
...
_DEFAULT_OFF_TOOLSETS = {"moa", "homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "revit"}
